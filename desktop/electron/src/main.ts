...
const DESKTOP_MESSAGES: Record<DesktopLocale, Record<string, string>> = {
  ...
  'zh-Hant': {
    ...
    'tray.open': '開啟 OpenSquilla',
    'tray.running': 'OpenSquilla 正在後台執行',
    'tray.quit': '退出 OpenSquilla',
    'tray.backgroundTitle': 'OpenSquilla 仍在執行',
    'tray.backgroundDetail': '任務、排程任務和已連線渠道會繼續在後台執行。可從系統托盤開啟或退出 OpenSquilla。',
    'closePrompt.title': '關閉 OpenSquilla？',
    'closePrompt.message': '關閉主視窗時要執行什麼操作？',
    'closePrompt.detail': '後台模式會繼續執行任務、排程任務和已連線渠道；顯式退出會安全停止本地執行時。',
    'closePrompt.background': '繼續在後台執行',
    'closePrompt.quit': '退出 OpenSquilla',
    'closePrompt.cancel': '取消',
    'closePrompt.remember': '記住我的選擇',
    'sandboxUnavailable.title': '安全模式目前不可用',
    'sandboxUnavailable.message': 'OpenSquilla 無法在此裝置上啟動沙箱。',
    'sandboxUnavailable.detail': '安全模式已停用。任務只能使用完全訪問，並將以宿主機許可權執行，存在額外的安全風險。',
    'sandboxUnavailable.acknowledge': '我知道了',
    'sandboxUnavailable.suppress': '不再提醒',
    'update.newVersionTitle': '有新版本可用',
    ...
    'update.manifestInvalid': '更新資訊無效，請稍後重試。',
    'update.sourceUnavailable': '更新服務暫時不可用，請稍後重試。',
    'update.checksumUnavailable': '無法取得官方校驗和，因此不能驗證安裝包；未開啟任何安裝包。',
    'update.integrityFailed': '下載的安裝包未透過完整性校驗，已將其刪除。',
    'update.downloadFailed': '更新下載安裝失敗，請重試。',
    'update.installFailed': '無法開啟更新安裝包，請重試。',
    ...
    'cleanup.moreItems': '個其他位置',
    'cleanup.cancel': '取消',
    'cleanup.deleteProfileConfirm': '刪除設定檔案',
    'cleanup.deleteProfileTitle': '刪除目前設定檔案？',
    'cleanup.deleteProfileMessage': '這會永久刪除列出的目前設定檔案資料、憑據和日誌。其他恢復設定檔案和備份會保留。',
    'cleanup.deleteAllConfirm': '刪除全部資料',
    'cleanup.deleteAllTitle': '刪除全部 OpenSquilla 使用者資料？',
    'cleanup.deleteAllMessage': 'OpenSquilla 會先退出。只有應用和本地執行時完全退出後，刪除才會開始。',
    ...
    'migration.overwriteNoMerge': '設定檔與聊天資料庫絕不會合併。',
    'migration.overwriteSourceUntouched': '所選來源設定檔保持原樣。',
    'migration.overwriteNoSync': '匯入後，桌面端設定檔與來源不會自動同步。',
    'migration.overwriteCancel': '取消',
...
const ONBOARDING_SCRIPT_MESSAGES: Record<DesktopLocale, Record<string, string>> = {
  ...
  'zh-Hant': {
    ...
    providerGroupRecommended: '推薦',
    providerGroupCloud: '雲端服務',
    providerGroupLocal: '本地服務',
    limitedFreeBadge: '限時免費',
    recommendedModel: '推薦模型',
    editModel: '修改',
    doneEditingModel: '完成',
    modelField: '模型',
    ...
    billingFree: '免費',
    billingPaid: '付費',
    searchFreeGroup: '免費搜尋',
    searchPaidGroup: '付費搜尋服務',
    apiKeyRequired: '需要 {label} API 金鑰。',
    verifyConfiguration: '驗證設定',
    verifyingConfiguration: '正在驗證…',
    configurationVerified: '設定驗證成功',
    configurationVerifiedWithLatency: '驗證成功 · {ms} ms',
    configurationVerificationFailed: '驗證失敗：{detail}',
    ...
    savingSetup: '正在儲存設定…',
    setupTakingLonger: '首次設定通常需要 10–20 秒，請保持此視窗開啟。',
    stepLabel: '步驟 {n}',
  },
  ja: {
