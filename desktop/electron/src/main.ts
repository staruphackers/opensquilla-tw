...
const DESKTOP_MESSAGES: Record<DesktopLocale, Record<string, string>> = {
  ...
  'zh-Hant': {
    ...
    'menu.profile': '設定檔',
    'menu.showProfile': '顯示目前設定檔',
    'menu.reviewProfile': '檢查設定檔路徑…',
    'menu.switchRecovery': '切換到恢復設定檔',
    'menu.returnPrimary': '返回主設定檔',
    'attention.title': '設定檔路徑需要處理',
    'attention.message': 'OpenSquilla 可以繼續使用目前工作區。你可以現在檢查偵測到的路徑，或保留目前路徑。',
    'attention.later': '稍後',
    'attention.keepCurrent': '保留目前路徑',
    'attention.chooseWorkspace': '選擇工作區…',
    'update.newVersionTitle': '有新版本可用',
    ...
    'cleanup.abandonConfirm': '保留並繼續',
    'cleanup.abandonTitle': '結束未完成的清理？',
    'cleanup.abandonMessage': 'OpenSquilla 會保留所有仍存在的檔案，僅歸檔清理事務記錄。',
    'cleanup.abandonDetail': '不會繼續刪除任何內容。繼續使用前請檢查剩餘的設定檔案。',
    ...
    'migration.step.manualTypeLabel': '設定檔類型',
    'migration.step.manualTypePlaceholder': '選擇設定檔類型',
    'migration.source.cli': 'OpenSquilla CLI（持續支援）',
    'migration.source.desktop': 'OpenSquilla 桌面端（持續支援）',
    'migration.source.portable': 'Windows Portable（歷史安裝方式，已停止支援）',
    'migration.step.browse': '選擇設定檔目錄…',
