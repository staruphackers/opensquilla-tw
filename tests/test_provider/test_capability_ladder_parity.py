...
_EXPECTED_CAPS: dict[tuple[str, str, str], tuple[bool, bool, bool, str]] = {
    ...
    ("volcengine_coding_plan", "doubao-seed-2-0-lite-260215", ""): (True, True, True, "volcengine"),
    ("volcengine_coding_plan", "doubao-seed-2-0-pro-260215", ""): (True, True, True, "volcengine"),
    (
