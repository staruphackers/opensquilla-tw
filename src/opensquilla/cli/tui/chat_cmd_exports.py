...
_CHAT_COMPAT_MODULE = "opensquilla.cli.tui.chat_compat"
_RUNTIME_BRIDGE_MODULE = "opensquilla.cli.tui.runtime_bridge"
_LAUNCH_BRIDGE_MODULE = "opensquilla.cli.tui.launch_bridge"
