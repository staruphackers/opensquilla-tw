...
METHOD_SCOPES: dict[str, str] = {
    ...
    "rag.status": READ_SCOPE,
    "rag.browse": READ_SCOPE,
    "rag.list": READ_SCOPE,
    "rag.search": READ_SCOPE,
    "rag.show": READ_SCOPE,
    ...
    "rag.add": WRITE_SCOPE,
    "rag.sync": WRITE_SCOPE,
    "rag.reindex": WRITE_SCOPE,
    "rag.enable_source": WRITE_SCOPE,
    "rag.disable_source": WRITE_SCOPE,
    "rag.remove_source": WRITE_SCOPE,
